...
parser.add_argument('--root_path', type=str,
                    default='/gpfs/work/cpt/diwu23/code/MERIT-main/data/feta/train', help='root dir for data')
parser.add_argument('--volume_path', type=str,
                    default='/gpfs/work/cpt/diwu23/code/MERIT-main/data/feta/test', help='root dir for validation volume data')
