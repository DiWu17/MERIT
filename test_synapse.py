...
parser.add_argument('--volume_path', type=str,
                    default='./data/feta/test', help='root dir for validation volume data')
...
def inference(args, model, test_save_path=None):
    ...
    for i in range(1, args.num_classes):
        ...
        logging.info('Mean class (%d) %s mean_dice %f mean_hd95 %f, mean_jacard %f' % (i, classes[i-1], metric_list[i-1][0], metric_list[i-1][1], metric_list[i-1][2]))
...
if __name__ == "__main__":
    ...
    snapshot_path = "D:\python\MERIT-main\model_pth\MERIT_Cascaded_Small_loss_MUTATION_w3_7_Synapse256\MERIT_Cascaded_Small_loss_MUTATION_w3_7_pretrain_30k_epo20_bs4_lr0.0001_256_s2222_run041822"
    ...
    snapshot = "D:/python/MERIT-main/model_pth/MERIT/best.pth"
